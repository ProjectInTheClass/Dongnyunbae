...
//            return " 대단합니다. 대부분의 식당들과 음식들이 이들의 입맛을 충족시켜 주지 못하는데 용케도 지금까지 살아남았군요.\n\n 오이형 사람과 식사약속을 잡으려는 친구는 분명 마음 깊이 스트레스가 쌓여있을 지도 모릅니다.  하지만 그만큼 오이형 사람의 식당추천은 거의 100% 확신이 들 정도로 믿음직한 추천입니다.\n\n 과연 이들의 귀한 선택을 받은 식당은 과연 몇 군데가 있을까요?"
            return " 가장 까다로운 기준을 가진 오이형 사람에게 실패는 없습니다.\n\n오이형 사람과 식사약속을 잡으려는 친구는 분명 마음 깊이 스트레스가 쌓여있을 지도 모릅니다. 하지만 그만큼 오이형 사람의 식당추천은 100% 확신이 들 정도로 믿음직한 추천입니다.\n\n왠만하면 이들에게 식당 선택을 맡기고 다른 이야기를 하는게 몸도 마음이 편하지 않을까요..?"
            
        case .EMBI :
            return " 감자형 사람에게는 음식에 자신만의 옳고 그름이 있습니다. 바로 저렴한 가격에 자신의 배를 푸짐하게 채워주는 것이죠.\n\n 착한 가격과 푸짐한 양으로 이들을 만족시키는 식당들이 다른 사람들에게는 불만 일수도 있어요.\n\n감자형 사람이 오이형 사람과 함께한다면 오이형 사람에게 선택을 맡겨보는건 어떨까요?"
//            return " 감자형 사람에게 음식은 옳고 그름이 있습니다. 정직하고 성실하며 위풍당당한 이들은 어떤 어려움이 닥쳐오더라도 이들이 추구하는 옳은 음식만을 먹습니다. 심지어 주변 사람들에게도 그들의 식사방식을 권면하기도 하죠.\n\n  만일 주변의 누군가가 뚜렷한 목표를 세우고 힘들어도 옳은 음식 먹기를 고수하는 이가 있다면 그는 바로 감자형 사람일 것입니다.\n\n 이들의 음식결정에 있어서 어떤 이들은 융통성이 없다고 할 지도 모릅니다. 하지만 감자형 사람의 성격이 외골수여서가 아니라 건강하고 옳은 음식을 먹는 것이 참된 길임을 굳게 믿는 강한 의지의 사람이기 때문인 것을 주변에서도 알아줘야 할 것입니다."
        ...
        case .HMGI :
            return " 냉철하면서도 왕성한 호기심을 가진 민트초코형은 상당히 도전적인 사람입니다.\n\n 푸짐하고 좋은 분위기의 가성비가 좋은 식당들을 찾는 데에도 재주가 있죠. 때문에 식사일정을 잡을 때 혼자 도맡아서 모든 걸 짊어질 때가 종종 생깁니다. 그만큼 대부분의 사람들이 이들의 도전적인 식당선택을 믿고 의지하는 편입니다. 그러나 때로는 이들의 확고한 입맛취향 때문에 호불호가 갈리는 식사도 생길 수도 있습니다. \n 그렇기에 몇몇의 식당을 결정 후에 팀원과 투표 결과도 반영하는 것은 어떨까요?  \n 명심하십시오. 민초는 모두의 음식이 아닌 것을. "
        ...
        case .HMBI :
            ...
            return " 한 자리에 우뚝 앉아서 냠냠쩝쩝 쉬지 않고 음식을 먹는 당신은 캔맥주형 사람입니다. \n  느릿느릿하면서도 꾸준히 먹는 모습으로 식사자리에서 이들만의 입지를 확고하게 다집니다. 나긋한 태도와는 달리! 손길에서는 음식을 향한 강렬한 의지가 느껴지기도 합니다. 또한 캔맥주형 사람은 많은 사람들과 회식 등의 식사자리가 많습니다. 그래서 사교성이 좋고 활발한 사람으로 비춰지지만 때로는 이들만의 혼술타임이 필요로 하는 사람이기도 합니다. \n 캔맥주형 사람과 친해지기 위해선 회식 자리에 자주 참석해보는 것은 어떨까요?"
...
//            return " 치아바타형 사람은 최고의 식사를 위해 힘쓰기를 좋아합니다. 음식에 진정성이 있으며 많은 에너지를 식사에 쓰고 식사를 통해 얻습니다. 코믹하게 식사의 분위기를 만들기도 합니다.\n\n 이들은 이들이 추구하는 식사를 위해서라면 어떠한 비용을 치룰 준비가 되어있습니다. 치아바타형 사람을 친구로 둔 사람들은 함께 식사할 때 얼마나 행복할까요?"
            return " 치아바타형 사람은 먹는것에 돈을 아끼지 않습니다.\n\n누가 먹어도 배부르고 분위기 좋은 식당이 가까운곳에 있다면 비용은 신경쓰지 않아요. 아마 단골손님이 될지도..?\n\n오이형 사람과는 비용적인 문제로 마찰이 생길수도 있으니 그들에게 맞춰주는게 어떨까요?"
...
//            return " 치킨형 사람은 도전적으로 식당 가는 것에 용기를 내기 어려워하는 사람에 속합니다. 찾아가기 어려운 식당은 큰 뜻을 품어야 겨우 가볼 수 있는 곳이죠. 그래서 배달료가 아깝더라도 시켜먹는 것이 일상입니다.\n\n 하지만 그 식당들에 가는 것과 먹는 것이 익숙해지면 분위기가 어떻든 아무렇지 않고 덤덤하게 푸짐한 식사를 즐깁니다.\n\n 배달음식만을 즐기다가 이렇게 하나씩 하나씩 가봄직한 식당들을 발견해간다면 치킨형 사람도 식사의 즐거움을 깨달을 수 있을 것입니다."
            return " 치킨형 사람들은 최대한 적게 움직여 든든하게 배를 채우고 싶어 합니다. 배달음식을 좋아하는 이유이기도 하죠.\n\n하지만 그 식달들에 가는 것과 먹는 것이 익숙해지면 분위기가 어떻든 신경쓰지 않고 덤덤히 푸짐한 식사를 즐깁니다.\n\n배달음식도 좋지만 하나 하나씩 가볼만한 식당들을 발견한다면 치킨형 사람들도 즐거운 식사를 위해 기꺼이 움직일 것입니다."
        ...
        case .HMGC :
           // return " 랍스터형 사람은 주로 푸짐하다는 특징이 있습니다. 어떤 음식이든  제아무리 그 몸값이 비싸더라도 이들은 꼭 푸짐하게 먹는 스타일을 고집합니다. 마치 스트리머들이 먹방찍듯이 말이죠.\n\n  또한 랍스터형 사람은 식사자리에서 이목을 많이 끄는 편이기도 합니다.\n 웃음거리를 안겨주기도 하는 이들은 식사행위를 즐거움의 컨텐츠로 승화시킵니다. 이들과 함께 밥 먹는 사람들은 이들을 두고 재밌는 사람이라고 느끼고 있을지도 모릅니다.  하지만 어떤 이들은 걱정어린 눈빛으로 랍스터형 사람들을 바라볼 수도 있습니다. 이들이 자기 형편에 비해 너무 과하게 음식을 먹는 게 아닌가 하고요.\n 절제하는 능력만 갖춰진다면 완벽한 멋쟁이가 될 것입니다."
            return " 분위기를 즐겨하며 푸짐한 식당을 좋아하는 당신! 당신은 랍스터형 사람입니다. \n 어떤 음식이든  제아무리 그 몸값이 비싸더라도 한번 먹는 식사는 맛있고 푸짐하게 먹는 스타일을 고집하죠. \n 또한 랍스터형 사람은 식사자리에서 사람들에게 이목을 많이 끄는 편이기도 합니다. 식사행위를 즐거움의 컨텐츠로 승화시키며 식사 분위기 자체를 띄우려고 노력합니다. 그렇기에 이들과 함께 식사를 한 사람들은 이들을 재밌는 사람이라고 생각하고 있을지도 모릅니다. 하지만 어떤 이들은 걱정어린 눈빛으로 랍스터형 사람들을 바라볼 수도 있습니다. 이들이 자기 형편에 비해 너무 과하게 음식을 먹는 게 아닌가 하고요.\n 한달에 한번 치팅데이를 정해보는 것은 어떨까요? 절제하는 능력만 갖춰진다면 완벽한 멋쟁이가 될 것입니다."
