...
//            return " 새우튀김형 사람은 매우 즉흥적이고 모험심이 강한 사람입니다. 길을 가다 마음에 드는 식당이 보이면 일단 들어가버리죠.\n\n 들어가면서부터 식당의 분위기에 취해 음식의 양이 적어도 알아차리지 못합니다. 계산서를 보고 식당을 나서며 웃을 수 있다면 단골 가게가 될지도 몰라요."
            return "식당을 고를 때, 사실 별 상관없는 듯하지만 마음속에 한 곳을 담아두고 있어요. 입맛에 안 맞더라도 다수의 의견을 잘 따르려고 하는 편이에요. 평소에는 음식에 돈을 많이 쓰려하진 않지만 특별한날에는 그래도 쓰려고 해서 한번씩 친구들한테 한턱쏘기도 해요. 가까운 곳에서 식사를 하는 걸 즐기지만, 다들 상관없어하면 멀리 가는 것도 괜찮아해요. 그래서 유명한 맛집들은 대부분 친구에게 이끌려서 접해보았어요. 플레이팅이 잘 된 음식을 보면 괜시리 기분이 좋아져, 그 식당에 대한 만족도가 높아져요. 거기다가 음식이 입맛에 맞다면 거긴 단골식당이 될 확률이 높아요."
